...
module Editor =
    ...
    type ContextKeyValue =
        U5<bool, float, string, Array<U3<bool, float, string> option>, Map<string, U3<bool, float, string> option>> option
    ...
    type [<AllowNullLiteral>] TextModelResolvedOptions =
        abstract _textModelResolvedOptionsBrand: unit
    ...
    type [<AllowNullLiteral>] ITextModel =
        ...
        /// <param name="preserveBOM">Preserve a BOM character if it was detected when the model was constructed.</param>
    ...
    type [<AllowNullLiteral>] IEditor =
        ...
        abstract createDecorationsCollection: ?decorations: ResizeArray<IModelDeltaDecoration> -> IEditorDecorationsCollection
    ...
    type [<AllowNullLiteral>] IUnicodeHighlightOptions =
        ...
        abstract allowedCharacters: Map<string, bool> option with get, set
        /// Unicode characters that are common in allowed locales are not being highlighted.
        abstract allowedLocales: Map<U2<string, string>, bool> option with get, set
...
module Languages =
    ...
    let [<Import("typescript","module/monaco/languages")>] typescript: Typescript.IExports = jsNative
    ...
    module Typescript =
        ...
        type [<AllowNullLiteral>] TypeScriptWorker =
            ...
            abstract provideInlayHints: fileName: string * start: float * ``end``: float -> Promise<ResizeArray<obj option>>
